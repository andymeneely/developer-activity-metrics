package edu.ncsu.csc.realsearch.apmeneel.devactivity.devnetwork.visualize.compare;
...
public class DeveloperNetworkCompare extends JApplet {
	...
	public DeveloperNetworkCompare(DeveloperNetwork dn) {
		graph = dn.getGraph();
	...
	public static void main(String[] args) throws Exception {
		...
		content.add(new DeveloperNetworkCompare(dn));
		frame.pack();
